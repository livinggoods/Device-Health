...
public class AdminService extends BaseService {
        ...
        if (email != null) {
            ...
            if (user != null) {
                ...
                if(status == true){
                    ...
                    passworResetEmail.setAuthenticator(new DefaultAuthenticator("itsupport@livinggoods.org", "%upp0rt720"));
                    ...
                    ((HtmlEmail) passworResetEmail).setHtmlMsg("<body style=\"background: #FFFFFF;\">   " +
                            ...
                            "<a href=\"" +
                            applicationParameters.getUrl()+"/password/reset/verify?token="+URLEncoder.encode(user.getForgotToken(), "UTF-8")+"\""+
    ...
    private String getJWT(Long id, String email) {
        long tokenLife;
        try {
